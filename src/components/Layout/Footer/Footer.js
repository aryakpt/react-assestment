      ...
      <div className='footer-container'>
        <div className='footer-wrap-left'>
          <img
            ...
            src='https://i.ibb.co/Tq1KQJc/packo-logo-white.png'
            alt='logo'
          />
          <p className='footer-title'>Pemadam kelaparan ketika kamu mager.</p>
        ...
        <div className='footer-wrap-right'>
          <img
            className='google'
            src='https://i.ibb.co/3S06Rc1/google-play-white.png'
            alt='google'
          />
